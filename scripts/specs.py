...
SECTIONS = {
    ...
    "sparql":          ("SHACL section 5 SPARQL-based Constraints", SHACL + "#sparql-constraints"),
    ...
    "components":      ("SHACL section 6 SPARQL-based Constraint Components", SHACL + "#sparql-constraint-components"),
    ...
    "afTargets":       ("SHACL-AF section 3 Custom Targets", AF + "#targets"),
    ...
    "afAnnotations":   ("SHACL-AF section 4 Annotation Properties", AF + "#sparql-constraints-annotations"),
    "afFunctions":     ("SHACL-AF section 5 SHACL Functions", AF + "#functions"),
    "afSparqlFunction":("SHACL-AF 5.4 SPARQL-based Functions", AF + "#SPARQLFunction"),
    "afNodeExpr":      ("SHACL-AF section 6 Node Expressions", AF + "#node-expressions"),
    ...
    "afExpression":    ("SHACL-AF section 7 Expression Constraints", AF + "#ExpressionConstraintComponent"),
    "afRules":         ("SHACL-AF section 8 SHACL Rules", AF + "#rules"),
    ...
    "c12nonValidating":("SHACL 1.2 Core section 8 Non-Validating Shape Characteristics", CORE12 + "#nonValidation"),
    "s12prefixes":     ("SHACL 1.2 SPARQL section 2 Prefix Declarations for SPARQL Queries", SPARQL12 + "#sparql-prefixes"),
    "s12constraints":  ("SHACL 1.2 SPARQL section 3 SPARQL-based Constraints", SPARQL12 + "#sparql-constraints"),
    ...
    "s12components":   ("SHACL 1.2 SPARQL section 4 SPARQL-based Constraint Components", SPARQL12 + "#sparql-constraint-components"),
    "s12nodeExpr":     ("SHACL 1.2 SPARQL section 6 SPARQL-based Node Expressions", SPARQL12 + "#sparql-node-expressions"),
    "s12select":       ("SHACL 1.2 SPARQL 6.1 Select Expressions", SPARQL12 + "#SelectExpression"),
    "s12functions":    ("SHACL 1.2 SPARQL section 7 Declaring SPARQL Functions based on Node Expressions", SPARQL12 + "#sparql-functions"),
    "n12intro":        ("SHACL 1.2 Node Expressions section 2 Getting started with Node Expressions", NODEEXPR12 + "#getting-started"),
    "n12library":      ("SHACL 1.2 Node Expressions section 4 Node Expressions Library", NODEEXPR12 + "#library"),
    "n12expression":   ("SHACL 1.2 Node Expressions 7.1 sh:expression", NODEEXPR12 + "#ExpressionConstraintComponent"),
    "r12overview":     ("SHACL 1.2 Rules section 3 SPARQL-RL", RULES12 + "#overview"),
    ...
    "sparqlPaths":     ("SPARQL 1.2 Query section 9 Property Paths", SPARQL + "#x9-property-paths"),
    "sparqlNegationSection": ("SPARQL 1.2 Query section 8 Negation", SPARQL + "#x8-negation"),
    "sparqlAggregates":("SPARQL 1.2 Query section 11 Aggregates", SPARQL + "#x11-aggregates"),
...
READING_LIST = [
    ("The specifications", [
        (SHACL, "Shapes Constraint Language (SHACL)",
         "The W3C Recommendation of 2017. Modules 01 to 06 and 10 are defined here; section 4 is the constraint component reference you will open most often, and Appendix D shows each Core component as the SPARQL it is equivalent to."),
